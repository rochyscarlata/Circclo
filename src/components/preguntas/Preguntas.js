        ...
        <Accordion className="preguntas-hijo">
          ...
          <Card>
            <Card.Header>
              <Accordion.Toggle className="acor" variant="link" eventKey="2">
                <h6 className="h6">
                  ¿De qué Calidad son los productos? ¿Ustedes hacen los
                  productos?
                </h6>
              </Accordion.Toggle>
            </Card.Header>
            <Accordion.Collapse eventKey="2">
              <Card.Body className="respuestasgrandes">
                <p className="respuestas">
                  ...
                  locales que tienen experiencia en el rubro hace ya varios años
                  y son 100% confiables. La calidad es similar a las primeras
          ...
          <Card>
            ...
            <Accordion.Collapse eventKey="5">
              <Card.Body className="respuestasgrandes">
                <p className="respuestas">
                  No. Los envases de CIRCCLO son específicos para los productos
          ...
          <Card>
            ...
            <Accordion.Collapse eventKey="8">
              <Card.Body>
                <p className="respuestas">
                  Recibimos cualquier método de pago. Los medios de pago son por
          ...
          <Card>
            ...
            <Accordion.Collapse eventKey="9">
              <Card.Body>
                <p className="respuestas">
                  No. El servicio es únicamente a través de envíos puerta a
                  puerta.
                </p>
              </Card.Body>
            </Accordion.Collapse>
          ...
          <Card>
            ...
            <Accordion.Collapse eventKey="14">
              <Card.Body className="respuestasgrandes">
                <p className="respuestas">
                  Siempre y cuando esté dentro de la franja horaria establecida,
                  se puede solicitar un horario aproximado
                </p>
              </Card.Body>
            </Accordion.Collapse>
          </Card>
          ...
          <Card>
            ...
            <Accordion.Collapse eventKey="16">
              <Card.Body>
                <p className="respuestas">
                  En el largo plazo, comprar Circclo es un 40%más económico que
                  comprar en el super, ya que el costo envase descartable está
                  incluido en el precio final y el consumidor lo paga cada vez
          ...
          <Card>
            <Card.Header>
              <Accordion.Toggle className="acor" variant="link" eventKey="17">
                <h6 className="h6">¿Tengo que pedir todo junto?</h6>
              </Accordion.Toggle>
            </Card.Header>
            <Accordion.Collapse eventKey="17">
              <Card.Body>
                <p className="respuestas">
                  No hace falta. Los productos se pueden pedir a medida que se
                  vayan terminando
                </p>
              </Card.Body>
            </Accordion.Collapse>
          ...
          <Card>
            ...
            <Accordion.Collapse eventKey="18">
              <Card.Body>
                <p className="respuestas">
                  No. Solo en caso de compras menores a $500, se cobra $50 de
                  envio.
                </p>
              </Card.Body>
            </Accordion.Collapse>
