    ...
    <div class="container contenedor-hiw">
      ...
      <Fade bottom>
        <h2 className="text-center howit">
          <FormattedMessage
            id="pasos.como"
            defaultMessage="COMO SOLUCIONAR ESTO?"
          />
        </h2>
      </Fade>
      <br></br>
      ...
      <div class="row text-center">
        <br></br>
        <div class="col">
          <img src={Paso1} alt="paso1" className="paso1"></img>
          <br></br>
          ...
          <h3 className="pasos-descrip">
            <FormattedMessage id="paso.uno" defaultMessage="Hace tu pedido" />
          </h3>
        </div>
        <div class="col">
          <img src={Paso2} alt="paso2" className="paso1"></img>
          <br></br>
        ...
        <div class="col">
          <img src={Paso3} alt="paso3" className="paso1"></img>
          <br></br>

          <span class="badge"> PASO 3</span>
          <br></br>
          <h3 className="pasos-descrip">
            <FormattedMessage id="paso.tres" defaultMessage="Pedí tu recarga" />
          </h3>
        </div>
      </div>
