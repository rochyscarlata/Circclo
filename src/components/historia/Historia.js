    ...
    <Container fluid="md">
      ...
      <Row>
        <Col sm className="columna-img">
          <Fade>
            <img src={Consumo} alt="consumo" className="img-consumo"></img>
          </Fade>
        </Col>
        <Col sm>
          <Fade>
            <h5 className="titulo-consumo">
              <FormattedMessage
                id="hist.consumo"
                defaultMessage="¿Somos conscientes de nuestro consumo?"
              />
            </h5>
      ...
      <Row>
        <Col sm className="columna-derecha">
          <Fade>
            <h5 className="titulo-consumo">
              <FormattedMessage
                id="hist.basura"
                defaultMessage="La basura no desaparece"
              />
            </h5>
            <br></br>
        ...
        <Col sm className="columna-img2">
          <Fade>
            <img src={Nadando} alt="basura" className="img-consumo"></img>
          </Fade>
        </Col>
      </Row>
      <br></br>
      ...
      <Row>
        <Col sm className="columna-img">
          <Fade>
            <img src={Reuso} alt="reusar" className="img-consumo"></img>
          </Fade>
        </Col>
        <Col sm>
          <Fade>
            <h5 className="titulo-consumo">
              <FormattedMessage
                id="hist.reuso"
                defaultMessage="Reciclar (Sólo) no es la respuesta"
              />
            </h5>
            <br></br>
        ...
        <Col sm className="columna-derecha">
          <Fade>
            <h5 className="titulo-consumo">
              <FormattedMessage
                id="hist.circular"
                defaultMessage="Economía circular"
              />
            </h5>
            <br></br>
      ...
      <Row>
        <Col sm className="columna-img">
          <Fade>
            <img
              src={Futuro}
              alt="futuro-de-consumir"
              className="img-consumo"
            ></img>
          </Fade>
        </Col>
        <Col sm>
          <Fade>
            <h5 className="titulo-consumo">
              <FormattedMessage
                id="hist.futuro"
                defaultMessage="El futuro de cómo consumimos"
              />
            </h5>
